...
//			
			...
			//System.out.println("Running on devie name >> "+ prop.getProperty("AndroidDeviceName"));
			options.setDeviceName(prop.getProperty("AndroidDeviceName"));
			//options.setDeviceName("Android Device");// real device	
			
			System.out.println("----> Cleaning and Setting the app..." + System.getProperty("user.dir")+"\\src\\test\\resources\\app\\Indigo1.apk");
			options.setApp(System.getProperty("user.dir")+"\\src\\test\\resources\\app\\Indigo1.apk");
