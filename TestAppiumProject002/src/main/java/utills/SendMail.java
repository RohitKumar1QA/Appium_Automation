...
//	public static void main(String ar[]) throws EmailException {
    public static void sendmail() throws EmailException {
        ...
        System.out.println(System.getProperty("user.dir") + "\\test-output-extent\\PdfReport\\IndigoTestReport.pdf");
        attachment.setPath(System.getProperty("user.dir") + "\\test-output-extent\\PdfReport\\IndigoTestReport.pdf");
        attachment.setDisposition(EmailAttachment.ATTACHMENT);
        attachment.setDescription("Report");
        attachment.setName("IndigoMobileAutomationReport.pdf");
        ...
        email.setAuthenticator(new DefaultAuthenticator("avinash.yadav@kellton.com", "xyz"));
        email.setSSLOnConnect(true);
        email.setFrom("avinash.yadav@kellton.com");
...
//        email.addCc("gaurav.tomar@kellton.com", "Gaurav Tomar");
        ...
        email.setSubject("Indigo Mobile Automation Report - Android");
        ...
        try {
            ...
            System.out.println("Failed To Attach the report");
        }
